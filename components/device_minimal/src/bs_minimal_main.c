...
typedef bs_basic_dev_args_t minimal_args_t;

char executable_name[] = "bs_device_minimal";
 ...
 */
void bs_minimal_argparse(int argc, char *argv[], minimal_args_t *args)
{
 ...
 * We do not need to do anything in this minimal device
...
int main(int argc, char *argv[]) {
  ...
  bs_minimal_argparse(argc, argv, &args);
